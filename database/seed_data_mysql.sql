-- =============================================================================
-- seed_data.sql â€” MySQL seed from MS Access (finaL.accde)
-- Source : D:\backup Daftar\StudentFiles\finaL.accdb
-- Created: 2026-07-20 09:40:37
-- Target : schema_mysql.sql
...
-- ---------------------------------------------------------------------------
INSERT INTO courses (course_id, title, price, is_active) VALUES (1, ' حمل و نقل جاده ای', 4700000, 1);
INSERT INTO courses (course_id, title, price, is_active) VALUES (2, 'محموله خطرناک', 3300000, 1);
INSERT INTO courses (course_id, title, price, is_active) VALUES (3, 'اتوبوس برون شهری', 4700000, 1);
INSERT INTO courses (course_id, title, price, is_active) VALUES (4, 'مدیر شرکت حمل و نقل', 4000000, 1);
INSERT INTO courses (course_id, title, price, is_active) VALUES (5, 'مدیر شرکت مسافر برون شهری', 5700000, 1);
INSERT INTO courses (course_id, title, price, is_active) VALUES (6, 'مسئول فنی', 4000000, 1);
...
-- ---------------------------------------------------------------------------
-- payments (Access: TblPeyment)  EnrollRef 0 -> NULL
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
ALTER TABLE students    AUTO_INCREMENT = 148;
ALTER TABLE courses     AUTO_INCREMENT = 7;
ALTER TABLE enrollments AUTO_INCREMENT = 149;
ALTER TABLE payments    AUTO_INCREMENT = 77;
